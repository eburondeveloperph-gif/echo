# Eburon Echo Landing Page

Landing page for eburon-echo.sh - a modern Next.js 16 application.
...
5. Configure custom domain `eburon-echo.sh` in Railway settings
...
├── public/
│   └── eburon-echo-logo.png   # Logo asset
