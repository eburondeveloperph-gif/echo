---
title: "API Overview"
description: "Integrate voice synthesis into your applications with the Eburon Echo REST API"
---

## Introduction

Eburon Echo exposes a full REST API that allows you to integrate voice synthesis into your own applications. The API runs on `http://localhost:17493` by default.

<Card title="Interactive API Docs" icon="book" href="http://localhost:17493/docs">
  When Eburon Echo is running, visit the auto-generated API documentation at `http://localhost:17493/docs`
</Card>
...
The Eburon Echo API is organized into several categories:
...
Eburon Echo provides an auto-generated TypeScript client with full type safety:

```typescript
import { EburonEchoClient } from '@/lib/api'

const client = new EburonEchoClient({
