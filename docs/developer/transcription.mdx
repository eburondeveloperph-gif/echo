---
title: "Transcription"
description: "How Whisper-based audio transcription works in Eburon Echo"
---

## Overview

Eburon Echo uses OpenAI's Whisper model for automatic speech recognition (ASR). This powers the transcription feature for creating reference text from audio recordings.
...
Whisper supports 99+ languages. Common ones in Eburon Echo:
