...
description: "How text-to-speech generation works in Eburon Echo"
---

## Overview

Eburon Echo uses Qwen3-TTS for voice cloning and text-to-speech generation. The TTS module handles model loading, voice prompt creation, and audio synthesis.
