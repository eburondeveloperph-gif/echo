...
description: "Common issues and solutions for Eburon Echo"
---

This guide covers common issues you might encounter when using or developing Eburon Echo, along with solutions.
...
xattr -cr /Applications/Eburon Echo.app
```
...
<AccordionGroup>
  ...
  <Accordion title="Permission Issues">
    ...
    ```bash
    # macOS/Linux
    chmod +x ~/Library/Application\ Support/com.eburon.echo.app/backend/eburon-echo-server
    ```
  </Accordion>
...
**Solutions:**
- Close all Eburon Echo instances
- Delete the lock file:
  ```bash
  # macOS
  rm ~/Library/Application\ Support/com.eburon.echo.app/data/eburon-echo.db-shm
  rm ~/Library/Application\ Support/com.eburon.echo.app/data/eburon-echo.db-wal
  ```
...
```bash
# macOS
rm ~/Library/Application\ Support/com.eburon.echo.app/data/eburon-echo.db

# Windows
del %APPDATA%\com.eburon.echo.app\data\eburon-echo.db
```
...
<AccordionGroup>
  ...
  <Accordion title="Check GPU Selection">
    If you have multiple GPUs, ensure Eburon Echo is using the right one.
...
1. **Check GitHub Issues:** [github.com/jamiepine/eburon-echo/issues](https://github.com/jamiepine/eburon-echo/issues)
2. **Open a New Issue:** Provide:
   - Operating system and version
   - Eburon Echo version
   - Steps to reproduce
   - Error messages or logs
3. **Join Discord:** [discord.gg/eburon-echo](https://discord.gg/eburon-echo) (coming soon)
...
For more detailed troubleshooting, see the [TROUBLESHOOTING.md](https://github.com/jamiepine/eburon-echo/blob/main/docs/TROUBLESHOOTING.md) file in the repository.
