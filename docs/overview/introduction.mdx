---
title: "Introduction"
description: "Welcome to Eburon Echo - the open-source voice synthesis studio"
---
...
<Frame>
  <img src="/images/app-screenshot-1.webp" alt="Eburon Echo App Screenshot" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/overview/installation">
    Download and install Eburon Echo on your machine
  </Card>
